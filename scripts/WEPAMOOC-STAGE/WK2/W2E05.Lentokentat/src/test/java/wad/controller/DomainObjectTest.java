...
public class DomainObjectTest {
    ...
    private final String AIRCRAFT_CLASSNAME = "wad.domain.Aircraft";
    private final String AIRPORT_CLASSNAME = "wad.domain.Airport";
    ...
    public void airportToAircraftsOneToManyCorrectlySet() {
        ...
        assertEquals("Annotation OneToMany for field aircrafts in class " + AIRPORT_CLASSNAME + "\nshould have a parameter fetch set to FetchType.EAGER.", FetchType.EAGER, oneToManyAnnotation.fetch());
    }
