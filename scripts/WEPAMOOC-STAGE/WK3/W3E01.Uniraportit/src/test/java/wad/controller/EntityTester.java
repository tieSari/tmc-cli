...
public class EntityTester {
    ...
    private void implementsSerializable(String className) {
        ...
        assertTrue("Class " + className + " should implement interface " + Serializable.class.getName() + ".", Serializable.class.isAssignableFrom(clazz));
    }
    ...
    public static void attributeHasGetMethod(String attributeName, String clazz, Class type) {
    ...
    public static void attributeHasSetMethod(String attributeName, String clazz, Class type) {
