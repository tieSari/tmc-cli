...
public class LyyrakorttiTest {
    ...
    public void toStringAlussaOikein() throws Throwable {
        ...
        assertFalse("Tee LyyraKortti-luokalle metodi public String toString() tehtävänannon ohjeen mukaan", vastaus.contains("@"));
        assertEquals("luotiin kortti = new LyyraKortti(" + summa + "); metodi toString ei toimi oikein:", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void onkoMetodiaSyoEdullisesti() throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi LyyraKortti lk = new LyyraKortti(4.0); lk.syoEdullisesti()";
    ...
    public void syoEdullisestiVahentaaSaldoa() throws Throwable {
        ...
        assertEquals("metodi syoEdullisesti ei taida vähentää oikein arvoa kortilta. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(6); kortti.syoEdullisesti(); System.out.println(kortti);\n",
        ...
        assertEquals("metodi syoEdullisesti ei taida vähentää oikein arvoa kortilta. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(6); kortti.syoEdullisesti(); kortti.syoEdullisesti(); System.out.println(kortti);\n",
                odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void onkoMetodiaSyoMaukkaasti() throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi LyyraKortti lk = new LyyraKortti(4.0); lk.syoMaukkaasti()";
    ...
    public void syoMaukkaastiVahentaaSaldoa() throws Throwable {
        ...
        assertEquals("metodi syoMaukkaasti ei taida vähentää oikein arvoa kortilta. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(10); kortti.syoMaukkaasti(); System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
        ...
        assertEquals("metodi syoMaukkaasti ei taida vähentää oikein arvoa kortilta. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(10); kortti.syoMaukkaasti(); kortti.syoEdullisesti(); System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void syoEdullisestiEiVieNegatiiviselle() throws Throwable {
        ...
        assertEquals("Saldo ei saisi mennä negatiiviseksi jos edulliseen lounaaseen ei ole varaa. Tarkasta että seuraava toimii: \n"
                + "kortti = new LyyraKortti(2); kortti.syoEdullisesti(); kortti.syoEdullisesti(); System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void syoMaukkaastiEiVieNegatiiviselle() throws Throwable {
        ...
        assertEquals("Saldo ei saisi mennä negatiiviseksi jos maukkaaseen lounaaseen ei ole varaa. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(7); kortti.syoMaukkaasti(); kortti.syoMaukkaasti(); System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void voiSyodaKokoRahalla() throws Throwable {
        ...
        String vastaus = toString(kortti);
        String odotettu = "Kortilla on rahaa " + (summa - 4) + " euroa";

        assertEquals("Jos kortilla on rahaa 4, pitäisi pystyä ostamaan syömään maukkaasti. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(4); kortti.syoMaukkasti();  System.out.println(kortti);", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void voiSyodaKokoRahalla2() throws Throwable {
        ...
        String vastaus = toString(kortti);
        String odotettu = "Kortilla on rahaa " + (summa - 2.5) + " euroa";

        assertEquals("Jos kortilla on rahaa 2.5, pitäisi pystyä ostamaan syömään edullisesti. \n"
                + "Tarkasta että seuraava toimii: kortti = new LyyraKortti(2.5); kortti.syoEdullisesti();  System.out.println(kortti);", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    /*
     * osa 4
     */
    ...
    public void onkoMetodiaMetodiLataaRahaa() throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi LyyraKortti lk = new LyyraKortti(4.0); lk.lataaRahaa(2.0);";
    ...
    public void rahaaVoiLadata() throws Throwable {
        ...
        assertEquals("Toimiiko metodi lataaRahaa? Tarkasta että seuraava toimii: \n"
                + "kortti = new LyyraKortti(7); kortti.lataaRahaa(3); System.out.println(kortti);\n"
                + "", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void ladatullaRahallaVoiOstaa() throws Throwable {
        ...
        assertEquals("Toimiiko metodi lataaRahaa? Tarkasta että seuraava toimii: \n"
                + "kortti = new LyyraKortti(1); kortti.lataaRahaa(5); kortti.syoMaukkaasti(); System.out.println(kortti);\n"
                + "", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void saldoEiKasvaYliRajan() throws Throwable {
        ...
        assertEquals("Kortin saldo ei saisi nousta suuremmaksi kuin 150. Tarkasta että seuraava toimii: \n"
                + "kortti = new LyyraKortti(100); kortti.lataaRahaa(100); kortti.syoMaukkaasti(); System.out.println(kortti);\n"
                + "", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void negatiivinenLatausEiMuutaSaldoa() throws Throwable {
        ...
        assertEquals("Negatiivisen latauksen ei pitäisi vaikuttaa mitään. Tarkasta että seuraava toimii:\n"
                + "kortti = new LyyraKortti(10); kortti.lataaRahaa(-7); kortti.syoMaukkaasti(); System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
        ...
        assertEquals("Negatiivisen latauksen ei pitäisi vaikuttaa mitään. Tarkasta että seuraava toimii:\n"
                + "kortti = new LyyraKortti(10); kortti.lataaRahaa(-7); kortti.lataaRahaa(1); kortti.lataaRahaa(-3);System.out.println(kortti);\n", odotettu.toLowerCase(), vastaus.toLowerCase());
    }
    ...
    public void montaKorttia() {
        ...
        for (String rivi : rivit) {
            assertTrue("Tulosta kortin tietojen kanssa saman rivin alussa kortin omistaja! Muista poistaa yliääräinen koodi pääohjelmasta kun teet tehtävää 77.6. ", rivi.toLowerCase().contains("pek") || rivi.toLowerCase().contains("mat"));
    ...
    private void syo(String miten, Object kortti) throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi lk = new LyyraKortti(4); lk." + metodi + "()";
    ...
    private void lataaRahaa(Object kortti, double maara) throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi lk = new LyyraKortti(4); lk." + metodi + "(" + maara + ")";
    ...
    private String toString(Object olio) throws Throwable {
        ...
        String v = "\nVirheen aiheuttanut koodi lk = new LyyraKortti(4); lk.toString()";
