...
public class MaatilasimulaattoriTest<S, L, R, N, M> {
    ...
    private void reflektoiLehma() {
        ...
        saniteettitarkastus(luokanNimi, 5, "nimen, utareiden tilavuuden ja utareiden maitomäärän muistavat oliomuuttujat");
    ...
    private void reflektoiNavetta() {
        ...
        saniteettitarkastus(luokanNimi, 2, "maitosäiliön ja lypsyrobotin muistavat oliomuuttujat");
    ...
    private void testaaNavetanLehmienHoitamista(N navetta, List<L> lehmat) throws Throwable {
        ...
        String v = "\n"
                ...
                + "nav.setLypsyrobotti( new Lypsyrobotti() );\n"
                + "nav.hoida(lehma1);";
    ...
    private void reflektoiMaatila() {
        ...
        saniteettitarkastus(luokanNimi, 3, "omistajan, navetan ja lehmät muistavat oliomuuttujat. ");
