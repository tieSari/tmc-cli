...
public class LyyraKorttiJaKassaPaateTest {
    ...
    public void eiLiikaaOliomuuttujiaKorttiin() {
        saniteettitarkastus("LyyraKortti", 1, "Älä lisää LyyraKortti-luokalle uusia oliomuuttujia, niitä ei tarvita");
    }
    ...
    public void kortiltaVoiOttaaRahaaJosSaldoRittaa() {
        assertEquals("Jos kortilla raha riittää, pitäisi otaRahaa-metodin palauttaa true. Tarkasta koodi: \n"
                + "k = new LyyraKortti(10); k.otaRahaa(8);", true, kortti.otaRahaa(8));
        assertEquals("Kortin saldon pitäisi vähetä kun rahaa otetaan. Tarkasta koodi: "
                + "k = new LyyraKortti(10); k.otaRahaa(8);", 2, kortti.saldo(), 0.01);
    }
    ...
    public void kortinVoiTyhjentaa() {
        assertEquals("Kortilta pitäisi pystyä ottamaan kaikki rahat. Tarkasta koodi: "
                + "k = new LyyraKortti(10); k.otaRahaa(10);", true, kortti.otaRahaa(10));
        assertEquals("Kortilta pitäisi pystyä ottamaan kaikki rahat. Tarkasta koodi: "
                + "k = new LyyraKortti(10); k.otaRahaa(10);", 0, kortti.saldo(), 0.01);
    }
    ...
    public void onnistunutMaukas() {
        ...
        assertEquals(virhe + "pitäisi metodin palauttaa vaihtorahan oikea määrä.", 1, vaihto, 0.01);

        assertTrue(virhe + " pitäisi kassassa olevan rahamäärän kasvaa 4.0 eurolla eli olla 1004.0. \nNyt kassa on: " + kassa, kassa.toString().contains("kassassa rahaa 1004"));
    ...
    public void onnistunutTasarahaMaukas() {
        double vaihto = kassa.syoMaukkaasti(4);

        String virhe = "Ostettaessa käteisellä 4:llä eurolla maukas lounas (eli kutsuttaessa kassa.syoMaukkaasti(4.0)) ";
        assertEquals(virhe + "kaikki raha kuluu, eli vaihtorahan pitäisi olla 0.", 0, vaihto, 0.01);

        assertTrue(virhe + " pitäisi kassassa olevan rahamäärän kasvaa 4.0 eurolla eli olla 1004.0- Nyt kassa on: " + kassa, kassa.toString().contains("kassassa rahaa 1004"));
    ...
    public void useitaMyyty() {
        ...
        String virhe = "Operaatioiden kassa.syoMaukkasti(5); kassa.SyoEdullisesti(3); kassa.syoMaukkasti(5);"
                + "kassa.syoMaukkasti(10);kassa.Edullisesi(4);";
        assertTrue(virhe + " jälkeen pitäisi kassassa olevan rahamäärän olla 1017 euroa. Nyt kassa on: " + kassa, kassa.toString().contains("kassassa rahaa 1017"));
    ...
    public void josEiRahaaMyyntiEpaonnistuuEiKassaanKosketa() {
        ...
        assertEquals("Kun yritetään ostaa liian pienellä rahamäärällä eli kassa.syoEdullisesti(2), pitäisi koko raha palauttaa taksisin", 2, paluu, 0.01);
        ...
        assertEquals("Kun yritetään ostaa liian pienellä rahamäärällä eli kassa.syoMaukkaasti(2), pitäisi koko raha palauttaa taksisin", 2, paluu, 0.01);
    ...
    public void onMetodiKortillaEdullisenOstoon() throws Throwable {
        ...
        assertTrue("tee luokalle " + klassNameK + " metodi public boolean " + metodi + "(LyyraKortti kortti) ",
                klassK.method(k, metodi).returning(boolean.class).taking(LyyraKortti.class).isPublic());

        String v = "\nVirheen aiheuttanut koodi "
                + "k = new Kassapaate(); lk = new LyyraKortti(10); k." + metodi + "(lk);";

        LyyraKortti lk = new LyyraKortti(10);

        klassK.method(k, metodi).returning(boolean.class).taking(LyyraKortti.class).withNiceError(v).invoke(lk);
    }

    @Points("86.3")
    @Test
    public void kortillaVoiOstaaEdullisenLounaanJosTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(10); kassa.syoEdullisesti(kortti);";
    ...
    public void kortillaVoiOstaaEdullisenLounaanJosJuuriJaJuuriTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(2.5); kassa.syoEdullisesti(kortti);";
    ...
    public void kortillaEiVoiOstaaEdullistaJosEiTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(2); kassa.syoEdullisesti(kortti);";
        kortti = new LyyraKortti(2);
        Boolean ok = syoEdullisesti(kassa, kortti);
    ...
    public void kortillaVoiOstaaMaukkaanLounaanJosTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(10); kassa.syoMaukkaasti(kortti);";
    ...
    public void kortillaVoiOstaaMaukkaanLounaanJosJuuriJaJuuriTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(4.0);";
    ...
    public void kortillaEiVoiOstaaMaukastaJosEiTarpeeksiRahaa() {
        String sken = "kassa = new Kassapaate(); kortti = new LyyraKortti(2);";
        kortti = new LyyraKortti(2);
        Boolean ok = syoMaukkaasti(kassa, kortti);
    ...
    public void onMetodiKortinLataamiseen() throws Throwable {
        ...
        assertTrue("tee luokalle " + klassNameK + " metodi public void " + metodi + "(LyyraKortti kortti, double summa) ",
                klassK.method(k, metodi).returningVoid().taking(LyyraKortti.class, double.class).isPublic());

        String v = "\nVirheen aiheuttanut koodi "
                + "k = new Kassapaate(); lk = new LyyraKortti(10); k." + metodi + "(lk, 5);";

        LyyraKortti lk = new LyyraKortti(10);

        klassK.method(k, metodi).returningVoid().taking(LyyraKortti.class, double.class).withNiceError(v).invoke(lk, 5.0);
    }
    ...
    public void lataaminenKasvattaaKortinSaldoa() {
        ...
        String virhe = "Tomiiko rahan lataaminen? tarkasta koodi:\n"
                + "kassa = new Kassapaate(); kortti = new LyyraKortti(10); kassa.lataaRahaaKortille(kortti, 10); kortti.saldo()";
    ...
    private void lataa(Object kassa, Object kortti, double summa) {
        ...
        try {
            Method metodi = ReflectionUtils.requireMethod(Kassapaate.class, metodiNimi, LyyraKortti.class, double.class);
            ReflectionUtils.invokeMethod(void.class, metodi, kassa, kortti, summa);
        } catch (Throwable t) {
            t.printStackTrace();
            fail("tee luokalle Kassapaate metodi public boolean lataaRahaaKortille(LyyraKortti kortti, double summa)");
        }
    }
    ...
    private boolean syoEdullisesti(Object kassa, Object kortti) {
        ...
        try {
            Method metodi = ReflectionUtils.requireMethod(Kassapaate.class, metodiNimi, LyyraKortti.class);
            return ReflectionUtils.invokeMethod(boolean.class, metodi, kassa, kortti);
        } catch (Throwable t) {
            t.printStackTrace();
            fail("tee luokalle Kassapaate metodi public boolean syoEdullisesti(LyyraKortti kortti)");
        }
        return false;
    }
    ...
    private boolean syoMaukkaasti(Object kassa, Object kortti) {
        ...
        try {
            ...
            t.printStackTrace();
            fail("tee luokalle Kassapaate metodi public boolean syoMaukkaasti(LyyraKortti kortti)");
        }
        return false;
    }
